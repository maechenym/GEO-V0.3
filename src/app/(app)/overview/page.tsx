                ...
                <div className="rounded-lg border border-ink-200 bg-white p-4 shadow-subtle hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <h2 className="text-sm font-semibold text-ink-900">{translate("Brand Influence Trends", language)}</h2>
                      <Tooltip>
                        <TooltipTrigger asChild>
                        ...
                        <TooltipContent>
                          <p className="text-xs">{getTooltipContent("Brand Influence Trends_tooltip", language)}</p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    <h2 className="text-sm font-semibold text-ink-900">
                      {translate("Top sources", language)}
                    </h2>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                      ...
                      <TooltipContent>
                        <p className="text-xs">{getTooltipContent("Top sources_tooltip", language)}</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-xs">{getTooltipContent("Top topics_tooltip", language)}</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                  <button
